...
console.log('Discarding tablespace and recreating users table...');
...
connection.connect((err) => {
  ...
  const discardTablespaceQuery = `ALTER TABLE users DISCARD TABLESPACE`;
  
  connection.query(discardTablespaceQuery, (err, results) => {
    if (err) {
