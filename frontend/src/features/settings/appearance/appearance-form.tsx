...
const appearanceFormSchema = z.object({
  theme: z.enum(['light', 'dark', 'simontok']),
  font: z.enum(fonts),
})
...
export function AppearanceForm() {
  ...
  const defaultValues: Partial<AppearanceFormValues> = {
    theme: theme as 'light' | 'dark' | 'simontok',
    font,
  }
            ...
            <FormItem>
              ...
              >
                ...
                <FormItem>
                  <FormLabel className='[&:has([data-state=checked])>div]:border-primary'>
                    <FormControl>
                      <RadioGroupItem value='simontok' className='sr-only' />
                    </FormControl>
                    <div className='border-muted hover:border-accent items-center rounded-md border-2 p-1'>
                      <div className='space-y-2 rounded-sm bg-white p-2'>
                        <div className='space-y-2 rounded-md bg-red-600 p-2 shadow-xs'>
                          <div className='h-2 w-[80px] rounded-lg bg-red-200' />
                          <div className='h-2 w-[100px] rounded-lg bg-red-200' />
                        </div>
                        <div className='flex items-center space-x-2 rounded-md bg-red-600 p-2 shadow-xs'>
